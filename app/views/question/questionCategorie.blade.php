...
<div class='row'>
    ...
    <div class='col-md-6'>
        @foreach($categories as $categorie)
            @if($categorie->id == $current)
                {{ link_to("question/categorie/{$categorie->id}",$categorie->categorie_name,['class'=>'label label-warning'])}}
            @else
                {{ link_to("question/categorie/{$categorie->id}",$categorie->categorie_name,['class'=>'label label-info'])}}
            @endif
        @endforeach
    </div>
    <div class='col-md-4'>
