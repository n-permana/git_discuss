...
<div class='row'>
    ...
    <div class='col-md-9 col-md-offset-1'>
        {{ Form::open(['route'=>'message.sendDraft','class'=>'form','files'=>true, 'id'=>'form'])}}
        <div class="form-group">
            ...
            {{Form::hidden('message_to',"$messages->message_to".",",['class'=>'form-control','id'=>'message_to'])}}
        ...
        <div>&nbsp;</div>
        <div class="form-group">
            {{Form::textArea('message_body',"$messages->message_body",['class'=>'form-control'])}}
